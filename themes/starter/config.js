...
const CONFIG = {
  ...
  STARTER_LOGO: '/images/starter/testimonials/icon-star.svg', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: '/images/starter/brands/graygrids-white.svg', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg
